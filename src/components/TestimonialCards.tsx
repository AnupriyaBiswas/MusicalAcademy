...
const musicSchoolTestimonials = [
    {
        quote: "Joining the music school transformed my understanding of music and helped me to truly discover my on sound, The instructors are world-class!",
        name: "Alex Johnson",
    ...
    {
        quote: "As a violinist, finding the right mentor can be challenging, but his school matched me with a teacher who truly understands my goals and challenges.",
        name: "Emily Taylor",
