...
function UpcomingWebinars() {
    ...
    const featuredWebinars = [
...

        {
            ...
            description: 'Learn the craft of songwriting from experience musicians and songwriters.',
...

        {
            ...
            description: 'Get started with music productions with this comprhensive overview.',
